...
<?php
  ...
  $qry4=mysqli_query($koneksi,"select * from siswa");
  $jumlah_siswa=mysqli_num_rows($qry4);
  $sisa_kuota=1000-$jumlah_siswa;

  $id = $_SESSION['id_akun'];
  $query1 = mysqli_query($koneksi, "select * from akun where id = '".$id."'");
          ...
          <div class="col-md-8">
            <div class="card card-user pb-2">
              <div class="card-header">
                ...
                <h5 class="card-title">lokasi untuk vaksinasi adalah <span class="text-danger font-weight-bold">Puskesmas Sita Kabupaten Manggarai Timur</span></h5>
                <h4 class="card-title">Jam mulai vaksinasi adalah <span class="text-danger font-weight-bold">jam 08:00-13:00</span></h4>
