...
<body class="homepage">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <div class="top-number">
                            <p><i class="fa fa-phone-square"></i> 081216388379</p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <div class="social">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    ...
                                    Selanjutnya peserta melakukan vaksinasi ke lokasi vaksni sesuai jadwal yang telah ditetapkan.</p>
                                    
                                    <a class="btn-slide animation animated-item-3" href="vaksin/login.php">Daftar vaksinasi</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/cor.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Aplikasi registrasi vaksinasi COVID-19 merupakan layanan pendaftaran vaksinasi COVID-19</h1>
                                    <div class="animation animated-item-2">
                                    Sebelum melakukan vaksinasi COVID-19, peserta mendaftar terlebih dahulu dengan cara klik tombol DAFTAR.
                                    Selanjutnya peserta melakukan vaksinasi ke lokasi vaksin sesuai jadwal yang telah ditetapkan.
                                    </div>
                                    <a class="btn-slide white animation animated-item-3" href="vaksin/login.php">Daftar Sekarang</a>
                                </div>
                            </div>
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2022 <a target="_blank" href="http://shapebootstrap.net/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">Vaksinasi Covid 19</a>. All Rights Reserved.
                </div>
            </div>
        </div>
    </footer>
